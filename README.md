...
<div class="ex-box">
➡️ Nous allons jouer avec quelques uns des LLM grand public assez connus. Vous pouvez ouvrir plusieurs onglets avec différentes solutions pour comparer les résultats.
</div>
<BR>
<BR>
...
- **Claude**: le modèle d'Anthropic [lien](https://claude.ai/)
    - le chatbot qui monte. Des initiatives du coté de l'éthique + l'état de l'art pour le codage informatique.
...
- **Grok**: pour voir la différence avec des modèles libertariens [lien](https://grok.com)
...
[Questions pédagogiques & analyse de documents](partiepedago)
