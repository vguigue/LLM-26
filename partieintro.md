...
- Quel est le style souhaité (long/court, scientifique/soutenu/vulgarisation/pour un enfant)? Qui souhaite-on voir répondre à la question?
...
Soit le document: [lien](https://github.com/vguigue/LLM-26/blob/main/ressources/sujet.pdf)
...
## A.7. Mise en forme des données brutes
...
### 7.b. Copier-coller de tableaux bruts (uniquement pour les utilisateurs de latex)
...
### 7.c Lettre de motivation / recommandation

CV (fictif) : [lien](https://github.com/vguigue/LLM-26/blob/main/ressources/CV_Vincent_Guigue.pdf)<BR>
Offre de thèse (fictive) : [lien](https://github.com/vguigue/LLM-26/blob/main/ressources/sujet.pdf)
